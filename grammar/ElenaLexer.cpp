...
ElenaLexer::ElenaLexer(CharStream *input) : Lexer(input) {
  _interpreter = new atn::LexerATNSimulator(this, _atn, _decisionToDFA, _sharedContextCache);
}

ElenaLexer::~ElenaLexer() {
  delete _interpreter;
}

std::string ElenaLexer::getGrammarFileName() const {
  return "ElenaLexer.g4";
}

const std::vector<std::string>& ElenaLexer::getRuleNames() const {
  return _ruleNames;
}

const std::vector<std::string>& ElenaLexer::getChannelNames() const {
  return _channelNames;
}

const std::vector<std::string>& ElenaLexer::getModeNames() const {
  return _modeNames;
}

const std::vector<std::string>& ElenaLexer::getTokenNames() const {
  return _tokenNames;
}

dfa::Vocabulary& ElenaLexer::getVocabulary() const {
  return _vocabulary;
}

const std::vector<uint16_t> ElenaLexer::getSerializedATN() const {
  return _serializedATN;
}

const atn::ATN& ElenaLexer::getATN() const {
  return _atn;
}

/* lexer definitions section */

void ElenaLexer::action(RuleContext *context, size_t ruleIndex, size_t actionIndex) {
  switch (ruleIndex) {
...
bool ElenaLexer::sempred(RuleContext *context, size_t ruleIndex, size_t predicateIndex) {
  switch (ruleIndex) {
...
void ElenaLexer::FooAction(antlr4::RuleContext *context, size_t actionIndex) {
  switch (actionIndex) {
...
void ElenaLexer::BarAction(antlr4::RuleContext *context, size_t actionIndex) {
  switch (actionIndex) {
...
bool ElenaLexer::FooSempred(antlr4::RuleContext *_localctx, size_t predicateIndex) {
...
bool ElenaLexer::BarSempred(antlr4::RuleContext *_localctx, size_t predicateIndex) {
  switch (predicateIndex) {
...
std::vector<dfa::DFA> ElenaLexer::_decisionToDFA;
atn::PredictionContextCache ElenaLexer::_sharedContextCache;

// We own the ATN which in turn owns the ATN states.
atn::ATN ElenaLexer::_atn;
std::vector<uint16_t> ElenaLexer::_serializedATN;

std::vector<std::string> ElenaLexer::_ruleNames = {
...
std::vector<std::string> ElenaLexer::_channelNames = {
  "DEFAULT_TOKEN_CHANNEL", "HIDDEN", "CommentsChannel", "DirectiveChannel"
};

std::vector<std::string> ElenaLexer::_modeNames = {
  "DEFAULT_MODE", "Mode1", "Mode2"
};

std::vector<std::string> ElenaLexer::_literalNames = {
  "", "", "'return'", "'continue'", "", "", "", "'<'", "'>'", "'='", "'and'", 
  "':'", "';'", "'+'", "'-'", "'*'", "'('", "')'", "'{'", "'}'", "'\u003F'", 
  "','", "", "", "", "", "", "", "'.'", "'..'", "'$'", "'&'"
};

std::vector<std::string> ElenaLexer::_symbolicNames = {
...
dfa::Vocabulary ElenaLexer::_vocabulary(_literalNames, _symbolicNames);

std::vector<std::string> ElenaLexer::_tokenNames;

ElenaLexer::Initializer::Initializer() {
...
ElenaLexer::Initializer ElenaLexer::_init;
